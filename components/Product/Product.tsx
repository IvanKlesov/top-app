...
import { priceRu, deсlOfNum } from "../../helper/helpers";
        ...
        <div className={className} ref={ref} {...props}>
            <Card className={styles.product}>
                ...
                <div className={styles.price}>
                    ...
                    {product.oldPrice && <Tag className={styles.oldPrice} color='green' aria-hidden={true}>{priceRu(product.price - product.oldPrice)}</Tag>}
                </div>
                ...
                <div className={styles.rateTitle}>
                    <a href="#ref" onClick={scrollToReview}>{product.reviewCount} {deсlOfNum(product.reviewCount, ['отзыв', 'отзыва', 'отзывов'])}</a>
                </div>
